package com.yincheng.game.utils;
...
public class TimeUtils {
    ...
    public static Date convertString2Date(String text, String pattern) {
        try {
            ...
            throw new IllegalArgumentException("time pattern error");
        }
    }

    public static Date convertDate2Date(Date date, String pattern) {
